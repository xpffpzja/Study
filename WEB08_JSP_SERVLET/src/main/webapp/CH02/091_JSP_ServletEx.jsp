...
<body>
<!-- 지정된 서블릿에 데이터를 보내고 reuqest의 attribute에 각 데이터를 담아서 92_JSP_ServletEx.jsp 파일로 전송
		각자의 형식을 자유롭게 출력
		서블릿 이름 : joinServlet  -->
<form method="post" action="../join.do">
      ...
      <span style="float: left; margin-right: 20px">
         ...
         <select id="job" name="job" size="1">
            <option value="">선택하세요</option><option value="학생">학생</option>
            <option value="컴퓨터/인터넷">컴퓨터/인터넷</option><option value="언론">언론</option>
         </select>   
      </span>
