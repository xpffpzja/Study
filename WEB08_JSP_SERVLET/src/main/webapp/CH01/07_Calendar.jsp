...
.container{width:700px; margin:0 auto; border:1px solid gray; 
...
int start_week = sDay.get(Calendar.DAY_OF_WEEK); // 현재달 1일의 요일(n번째 일,  1번째-일요일/2번째-월요일.../7번째-토요일) 추출
%>
<div class="title">
	...
	&nbsp;
	<%
	out.print("<span style='font:size180%; font-weight:bold'>" + sYear + "년" + (sMonth +1 )+"월</span>");
	%>
