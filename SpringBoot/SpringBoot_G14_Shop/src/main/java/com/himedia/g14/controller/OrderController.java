...
public class OrderController {
    ...
    public String orderInsert(@RequestParam("cseq") String [] cseqs, HttpServletRequest resquest) {
    ...
    public ModelAndView orderList(@RequestParam("oseq") int oseq, HttpServletRequest resquest, Model model) {
    ...
    public String orderInsertOne(@RequestParam("pseq") int pseq, @RequestParam("quantity") int quantity,
    ...
    @GetMapping("/mypage")
    public ModelAndView mypage(HttpServletRequest resquest, Model model) {
        ModelAndView mav = new ModelAndView();
        HttpSession session = resquest.getSession();
        MemberVO loginUser = (MemberVO)session.getAttribute("loginUser");
        if(loginUser == null)
    ...
    @GetMapping("/orderAll")
    public ModelAndView orderAll(HttpServletRequest resquest, Model model) {
        ModelAndView mav = new ModelAndView();
        HttpSession session = resquest.getSession();
        MemberVO loginUser = (MemberVO)session.getAttribute("loginUser");
        if(loginUser == null)
