...
--Table : 데이터 베이스에서 사용되는 데이터 집합의 단위. 흔이 알고있는 "표" 양식
...
--현재 출시되어 데이터 베이스로 활용되는 제품들 : 오라클, MySQL, MSSQL,  MariaDB, 
--		MongoDB, Access등 
...
--오라클데이터 베이스에서 사용가능한 DBMS : SQL Developer, SQLPUS, 이클립스 등



--데이터 베이스에 활용되는 언어(Language)
--SQL(Strictired Query Language) : 관계형 데이터 베이스 관리 시스템(RDBMS)의
...
--Create : 테이블, 뷰, 사용자 등을 생성할떄 사용하는 명령
